---
title: "Installation"
description: "Install OwnPay on Shared Hosting (cPanel, Plesk, DirectAdmin), a VPS, or Docker using the built-in web installer and setup wizard."
...
<Steps>
  <Step title="Download the Release Package">
    1. Visit the official [OwnPay GitHub Releases]({{github}}/releases) page.
    2. Identify the top **Latest Release** tag.
    3. Under the **Assets** section, download the `.zip` archive (e.g. `ownpay-vX.Y.Z.zip`).
  </Step>
