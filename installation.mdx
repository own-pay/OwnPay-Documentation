---
title: "Installation"
description: "Install OwnPay on shared hosting (cPanel, DirectAdmin, Plesk), a VPS (Ubuntu or Debian), or Docker using the built-in web installer and setup wizard."
...
1. Go to the [OwnPay GitHub Releases page]({{github}}/releases/)
