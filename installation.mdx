...
description: "Install OwnPay on shared hosting, a VPS, or with Docker, including database setup, environment variables, and running the first-time setup wizard."
---
