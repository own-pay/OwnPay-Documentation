---
title: "Custom domain pipeline"
description: "How OwnPay routes brand traffic through custom domains with automated SSL provisioning, DNS verification, and per-tenant checkout isolation."
---
