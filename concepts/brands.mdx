...
description: "OwnPay isolates each brand with its own customers, gateways, credentials, ledgers, staff, and custom domain through strict multi-tenant scoping."
---
