...
export default defineConfig({
  ...
  description: 'Official Documentation for OwnPay self-hosted fintech infrastructure.',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'API Reference', link: '/api-reference/', activeMatch: '/api-reference/' },
      {
        ...
        items: [
          ...
          { text: 'GitHub', link: 'https://github.com/own-pay/ownpay-docs' },
        ],
      },
    ],
    ...
    sidebar: {
      ...
      '/user-guide/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Developer Hub', link: '/user-guide/developers/developer-hub' },
          ],
        },
        {
      ...
      '/api-reference/': [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: 'API Keys', link: '/api-reference/authentication' },
          ],
        },
        {
          text: 'Payments',
          collapsed: false,
          items: [
            { text: 'Initiate Payment', link: '/api-reference/initiate-payment' },
          ],
        },
      ],
    },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/own-pay/ownpay-docs' },
    ],
    ...
    editLink: {
      pattern: 'https://github.com/own-pay/ownpay-docs/edit/main/:path',
