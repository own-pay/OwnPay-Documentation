...
- **🌍 Translate** - add or improve a language catalog (see [TRANSLATIONS.md](https://github.com/own-pay/OwnPay/blob/main/docs/TRANSLATIONS.md)).
...
2. Follow **[Local Setup](./local-setup)** to get a local instance running (~2 minutes).
...
For the full feature inventory, see the **[Feature Reference](./features)**. For the bigger picture, read the **[Architecture Guide](./architecture)**.
...
See the gateway developer guide on **[Gateway Developer Guide](/developer/plugin-types/gateway-development)** for the full contract and examples.

---

## 🌍 Contributing Translations

OwnPay has full i18n for both the admin panel and customer checkout. To add or update a language, follow **[TRANSLATIONS.md](https://github.com/own-pay/OwnPay/blob/main/docs/TRANSLATIONS.md)** - create a dot-notation JSON catalog (keep `:placeholders` intact) and place core languages in `config/languages/`.
