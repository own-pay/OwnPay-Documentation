---
title: "Quickstart"
description: "Get OwnPay running in 5 minutes using a hosted trial or Docker, connect a payment gateway, create your first brand, and accept a test payment."
---

Get OwnPay running on your server in minutes. This guide covers the fastest path from zero to processing payments.
