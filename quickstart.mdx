  ...
  <Tab title="Shared Hosting" icon="globe">
    ...
    <Steps>
      <Step title="Download OwnPay">
        Go to the [GitHub Releases page]({{github}}/releases/) and download the latest `.zip` file.
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="API integration" icon="code" href="/api-reference/merchant">
    Integrate OwnPay with your applications via REST API.
  </Card>
  <Card title="Gateway plugins" icon="plug" href="/developer/plugins/gateways">
...
<Tip>
Need help? Check our [Troubleshooting guide](/advanced-topics/troubleshooting) or open an issue on [GitHub]({{github}}/issues).
</Tip>
