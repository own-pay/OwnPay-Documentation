...
<AccordionGroup>
  ...
  <Accordion title="Can I install OwnPay on shared hosting?">
    Yes. OwnPay works with cPanel, DirectAdmin, and Plesk hosting. You need PHP 8.3 support and MySQL. See the [Shared Hosting](/deployment/installation#shared-hosting) installation guide.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Can I customize the checkout appearance?">
    Yes. OwnPay supports theme plugins for full checkout customization. Each brand can also set custom colors, logos, CSS, and JavaScript. See [Theme Plugins](/plugins/theme-plugins).
  </Accordion>
  ...
  <Accordion title="Can I extend OwnPay with plugins?">
    Yes. OwnPay has a WordPress-style plugin system. You can build custom gateways, themes, and addons. See [Plugin Development](/plugins/developer-guide).
  </Accordion>
</AccordionGroup>
