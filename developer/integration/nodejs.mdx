---
title: "Node.js Integration - REST API and HMAC Webhook Setup"
description: "Integrate OwnPay into a Node.js 18+ backend using the REST API, HMAC-signed webhooks, and environment-based API key management for security."
keywords: "Node.js payment integration, REST API, HMAC webhooks, payment gateway Node.js, API key management"
...
- [Webhook verification](/api/webhooks) - Receive server-push payment events
