...
- OwnPay Gateway Plugin for WooCommerce - download from [GitHub Releases]({{githubWordpress}}/releases/)
...
1. Download the latest plugin ZIP from [GitHub Releases]({{githubWordpress}}/releases/)
