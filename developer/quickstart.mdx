...
- [Full PHP SDK Guide](/developer/sdk-integration/php) - Complete API reference for PHP
- [Full Node.js SDK Guide](/developer/sdk-integration/nodejs) - Complete API reference for Node.js
- [Webhook Events](/api/webhooks) - All webhook event types
- [Build a Plugin](/developer/plugins/gateways) - Extend OwnPay with plugins
