---
title: "Roles and Permissions - RBAC for Admin and Brand Access"
description: "Define role-based access control (RBAC) roles and map granular capability flags across OwnPay's system, brand, and reporting admin modules."
keywords: "roles, permissions, RBAC, access control, admin roles, capability flags"
sidebarTitle: "Roles"
---
