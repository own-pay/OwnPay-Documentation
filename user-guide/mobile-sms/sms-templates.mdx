---
title: "SMS Center - Parsing Templates and Auto-Verification"
description: "Create and manage regex rules and heuristic patterns that parse incoming bank SMS messages to auto-verify mobile wallet payments in OwnPay."
keywords: "SMS templates, SMS parsing, auto-verification, mobile wallet, bank SMS regex"
