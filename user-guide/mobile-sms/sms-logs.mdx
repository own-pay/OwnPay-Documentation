---
title: "SMS Data Logs - Review Forwarded Messages and Payments"
description: "Review raw forwarded SMS messages, inspect parser extraction status, and manually resolve unmatched incoming payments from the OwnPay admin."
keywords: "SMS logs, forwarded SMS, payment SMS, SMS parser, unmatched payments"
