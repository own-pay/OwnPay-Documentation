---
title: "Merchant API Reference - Payments, Refunds, and Webhooks"
description: "Merchant REST API endpoints for creating payments, managing customers, issuing refunds, and configuring webhooks per brand in OwnPay."
keywords: "Merchant API, payment API, create payment, refund API, webhook configuration"
